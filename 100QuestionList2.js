...
// 	2.	Log the value of a variable before and after incrementing it using ++.
    // var arr = 5
    // console.log("before increment + arr")
    // arr++
    // console.log("after increment + arr")
    ...
    //     let y = 10;
    // // Pre-increment
    // console.log("Before Pre-increment:", y); 
    // ++y; 
    // console.log("After Pre-increment:", y); 
...
// 	4.	Create a variable with a template literal that includes your name and age.
    ...
    // let literalMessage = `hello, my name is ${name} and i am ${age} years old`
